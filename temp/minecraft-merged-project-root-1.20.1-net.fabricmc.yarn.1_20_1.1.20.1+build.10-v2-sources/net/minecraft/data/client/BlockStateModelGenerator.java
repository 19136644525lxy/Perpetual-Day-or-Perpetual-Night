...
public class BlockStateModelGenerator {
    ...
    public final void registerWeightedPressurePlate(Block weightedPressurePlate, Block textureSource) {
        ...
        this.blockStateCollector.accept(VariantsBlockStateSupplier.create(weightedPressurePlate).coordinate(BlockStateModelGenerator.createValueFencedModelMap(Properties.POWER, 1, identifier2, identifier)));
    }
