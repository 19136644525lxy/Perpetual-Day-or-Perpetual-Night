...
implements Recipe<Inventory> {
    ...
    implements RecipeSerializer<T> {
        ...
        public T read(Identifier identifier, JsonObject jsonObject) {
            ...
            Ingredient ingredient = JsonHelper.hasArray(jsonObject, "ingredient") ? Ingredient.fromJson(JsonHelper.getArray(jsonObject, "ingredient"), false) : Ingredient.fromJson(JsonHelper.getObject(jsonObject, "ingredient"), false);
