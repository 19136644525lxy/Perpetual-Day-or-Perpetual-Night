...
Vibrations {
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        Vibrations.ListenerData.CODEC.encodeStart(NbtOps.INSTANCE, this.vibrationListenerData).resultOrPartial(LOGGER::error).ifPresent(nbtElement -> nbt.put("listener", (NbtElement)nbtElement));
