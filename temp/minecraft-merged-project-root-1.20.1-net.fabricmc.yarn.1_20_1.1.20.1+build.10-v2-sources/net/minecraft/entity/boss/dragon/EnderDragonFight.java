...
public class EnderDragonFight {
    ...
    public record Data(boolean needsStateScanning, boolean dragonKilled, boolean previouslyKilled, boolean isRespawning, Optional<UUID> dragonUUID, Optional<BlockPos> exitPortalLocation, Optional<List<Integer>> gateways) {
        public static final Codec<Data> CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.BOOL.fieldOf("NeedsStateScanning")).orElse(true).forGetter(Data::needsStateScanning), ((MapCodec)Codec.BOOL.fieldOf("DragonKilled")).orElse(false).forGetter(Data::dragonKilled), ((MapCodec)Codec.BOOL.fieldOf("PreviouslyKilled")).orElse(false).forGetter(Data::previouslyKilled), Codec.BOOL.optionalFieldOf("IsRespawning", false).forGetter(Data::isRespawning), Uuids.INT_STREAM_CODEC.optionalFieldOf("Dragon").forGetter(Data::dragonUUID), BlockPos.CODEC.optionalFieldOf("ExitPortalLocation").forGetter(Data::exitPortalLocation), Codec.list(Codec.INT).optionalFieldOf("Gateways").forGetter(Data::gateways)).apply((Applicative<Data, ?>)instance, Data::new));
