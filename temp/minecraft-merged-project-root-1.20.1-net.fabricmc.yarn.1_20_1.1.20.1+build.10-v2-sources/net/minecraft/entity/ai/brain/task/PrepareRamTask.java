...
extends MultiTickTask<E> {
    ...
    protected void run(ServerWorld serverWorld, PathAwareEntity pathAwareEntity, long l) {
        ...
        brain.getOptionalRegisteredMemory(MemoryModuleType.VISIBLE_MOBS).flatMap(mob -> mob.findFirst(mobx -> this.targetPredicate.test(pathAwareEntity, (LivingEntity)mobx))).ifPresent(mob -> this.findRam(pathAwareEntity, (LivingEntity)mob));
    }
