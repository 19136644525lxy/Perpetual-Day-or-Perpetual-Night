...
public class StructureTestUtil {
    ...
    public static StructureBlockBlockEntity createStructureTemplate(String templateName, BlockPos pos, BlockRotation rotation, int i, ServerWorld world, boolean interactive) {
        BlockPos blockPos;
        ...
        StructureTestUtil.clearArea(blockBox, pos.getY(), world);
        StructureBlockBlockEntity structureBlockBlockEntity = StructureTestUtil.placeStructureTemplate(templateName, blockPos, rotation, world, interactive);
