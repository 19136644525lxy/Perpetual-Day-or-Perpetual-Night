...
implements Font {
    ...
    public Glyph getGlyph(int codePoint) {
        ...
        try (MemoryStack memoryStack = MemoryStack.stackPush();){
            ...
            STBTruetype.stbtt_GetGlyphBitmapBoxSubpixel(sTBTTFontinfo, i, this.scaleFactor, this.scaleFactor, this.shiftX, this.shiftY, intBuffer, intBuffer2, intBuffer3, intBuffer4);
        ...
        public GlyphRenderer bake(Function<RenderableGlyph, GlyphRenderer> function) {
            return function.apply(new RenderableGlyph(){
                ...
                public void upload(int x, int y) {
                    ...
                    nativeImage.makeGlyphBitmapSubpixel(sTBTTFontinfo, TtfGlyph.this.glyphIndex, TtfGlyph.this.width, TtfGlyph.this.height, TrueTypeFont.this.scaleFactor, TrueTypeFont.this.scaleFactor, TrueTypeFont.this.shiftX, TrueTypeFont.this.shiftY, 0, 0);
