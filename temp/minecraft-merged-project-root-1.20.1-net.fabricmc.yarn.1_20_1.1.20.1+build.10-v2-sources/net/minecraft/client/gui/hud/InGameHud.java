...
public class InGameHud {
    ...
    public void render(DrawContext context, float tickDelta) {
        ...
        if ((g = MathHelper.lerp(tickDelta, this.client.player.prevNauseaIntensity, this.client.player.nauseaIntensity)) > 0.0f && !this.client.player.hasStatusEffect(StatusEffects.NAUSEA)) {
