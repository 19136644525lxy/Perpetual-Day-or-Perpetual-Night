...
extends Screen {
    ...
    protected void init() {
        ...
        adder2.add(ButtonWidget.builder(ScreenTexts.COPY_LINK_TO_CLIPBOARD, button -> this.client.keyboard.setClipboard("https://aka.ms/MinecraftSymLinks")).size(120, 20).build());
