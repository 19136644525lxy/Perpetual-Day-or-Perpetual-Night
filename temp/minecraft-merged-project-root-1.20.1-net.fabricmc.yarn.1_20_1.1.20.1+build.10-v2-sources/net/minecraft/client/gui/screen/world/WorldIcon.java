...
implements AutoCloseable {
    ...
    public static WorldIcon forWorld(TextureManager textureManager, String worldName) {
        return new WorldIcon(textureManager, new Identifier("minecraft", "worlds/" + Util.replaceInvalidChars(worldName, Identifier::isPathCharacterValid) + "/" + Hashing.sha1().hashUnencodedChars(worldName) + "/icon"));
    }
