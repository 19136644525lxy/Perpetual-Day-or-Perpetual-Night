...
extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        int i = -16;
        modelPartData.addChild(EntityModelPartNames.BODY, ModelPartBuilder.create().uv(0, 0).cuboid(-6.0f, -8.0f, -6.0f, 12.0f, 16.0f, 12.0f, dilation), ModelTransform.pivot(0.0f, 8.0f, 0.0f));
        int j = 8;
