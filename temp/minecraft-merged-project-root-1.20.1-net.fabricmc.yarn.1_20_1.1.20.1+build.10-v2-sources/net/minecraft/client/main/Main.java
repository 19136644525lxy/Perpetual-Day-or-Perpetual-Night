...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ArgumentAcceptingOptionSpec<String> optionSpec13 = optionParser.accepts("username").withRequiredArg().defaultsTo("Player" + Util.getMeasuringTimeMs() % 1000L, (String[])new String[0]);
        ...
        ArgumentAcceptingOptionSpec<String> optionSpec26 = optionParser.accepts("userType").withRequiredArg().defaultsTo(Session.AccountType.LEGACY.getName(), (String[])new String[0]);
        ...
        String string = Main.getOption(optionSet, optionSpec9);
        Proxy proxy = Proxy.NO_PROXY;
        if (string != null) {
            try {
                proxy = new Proxy(Proxy.Type.SOCKS, new InetSocketAddress(string, (int)Main.getOption(optionSet, optionSpec10)));
            } catch (Exception exception) {
                // empty catch block
            }
        }
        final String string2 = Main.getOption(optionSet, optionSpec11);
        final String string3 = Main.getOption(optionSet, optionSpec12);
        ...
        String string4 = Main.getOption(optionSet, optionSpec18);
        ...
        String string5 = Main.getOption(optionSet, optionSpec27);
        ...
        String string11 = Main.getOption(optionSet, optionSpec3);
        String string12 = Main.getOption(optionSet, optionSpec4);
        String string13 = Main.getOption(optionSet, optionSpec5);
