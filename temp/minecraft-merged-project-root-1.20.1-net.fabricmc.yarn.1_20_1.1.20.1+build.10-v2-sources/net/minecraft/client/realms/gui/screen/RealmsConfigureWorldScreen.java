...
extends RealmsScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.isMinigame()) {
            context.drawText(this.textRenderer, Text.translatable("mco.configure.world.minigame", this.server.getMinigameName()), this.left_x + 80 + 20 + 10, RealmsConfigureWorldScreen.row(13), 0xFFFFFF, false);
        }
