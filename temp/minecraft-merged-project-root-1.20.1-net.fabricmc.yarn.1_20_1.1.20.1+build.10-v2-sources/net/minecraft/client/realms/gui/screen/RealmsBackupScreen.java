...
extends RealmsScreen {
    ...
    void restoreClicked(int selectedBackup) {
        if (selectedBackup >= 0 && selectedBackup < this.backups.size() && !this.serverData.expired) {
            ...
            MutableText text3 = Text.translatable("mco.configure.world.restore.question.line2");
    ...
    extends AlwaysSelectedEntryListWidget.Entry<BackupObjectSelectionListEntry> {
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            context.drawText(RealmsBackupScreen.this.textRenderer, Text.translatable("mco.backup.entry", RealmsUtil.convertToAgePresentation(this.mBackup.lastModifiedDate)), x, y + 1, i, false);
