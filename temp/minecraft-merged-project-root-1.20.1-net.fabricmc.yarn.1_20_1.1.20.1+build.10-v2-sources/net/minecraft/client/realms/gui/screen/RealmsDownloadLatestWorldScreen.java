...
extends RealmsScreen {
    ...
    private void drawProgressBar(DrawContext context) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, Text.translatable("mco.download.percent", this.progress), this.width / 2, 84, 0xFFFFFF);
    }
    ...
    private void drawDownloadSpeed0(DrawContext context, long bytesPerSecond) {
        if (bytesPerSecond > 0L) {
            ...
            context.drawText(this.textRenderer, Text.translatable("mco.download.speed", SizeUnit.getUserFriendlyString(bytesPerSecond)), this.width / 2 + i / 2 + 15, 84, 0xFFFFFF, false);
        }
    }
