...
extends RealmsScreen {
    ...
    public void init() {
        ...
        this.inviteButton = this.addDrawableChild(ButtonWidget.builder(Text.translatable("mco.configure.world.buttons.invite"), button -> this.onInvite()).dimensions(this.width / 2 - 100, RealmsInviteScreen.row(10), 200, 20).build());
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(this.textRenderer, INVITE_PROFILE_NAME_TEXT, this.width / 2 - 100, RealmsInviteScreen.row(1), -1, false);
        if (this.errorMessage != null) {
            context.drawCenteredTextWithShadow(this.textRenderer, this.errorMessage, this.width / 2, RealmsInviteScreen.row(5), -1);
        }
