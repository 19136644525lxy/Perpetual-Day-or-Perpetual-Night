...
extends RealmsScreen {
    ...
    public void init() {
        if (this.yesNoQuestion) {
            ...
            this.addDrawableChild(ButtonWidget.builder(ScreenTexts.OK, button -> this.callback.accept(true)).dimensions(this.width / 2 - 50, RealmsLongConfirmationScreen.row(8), 100, 20).build());
        }
    }
    ...
    public static enum Type {
        WARNING(WARNING_TEXT, 0xFF0000),
        INFO(INFO_TEXT, 8226750);
