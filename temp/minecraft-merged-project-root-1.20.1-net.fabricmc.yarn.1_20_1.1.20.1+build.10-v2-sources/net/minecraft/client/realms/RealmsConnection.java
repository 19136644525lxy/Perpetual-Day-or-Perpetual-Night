        ...
        new Thread("Realms-connect-task"){
            ...
            public void run() {
                ...
                try {
                    ...
                    ClientLoginNetworkHandler clientLoginNetworkHandler = new ClientLoginNetworkHandler(RealmsConnection.this.connection, minecraftClient, server.createServerInfo(string), RealmsConnection.this.onlineScreen, false, null, status -> {});
                    ...
                    RealmsConnection.this.connection.send(new LoginHelloC2SPacket(string3, Optional.ofNullable(uUID)));
