...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions conditionsFromJson(JsonObject jsonObject, LootContextPredicate lootContextPredicate, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new Conditions(lootContextPredicate, intRange, intRange2, intRange3, itemPredicates);
    }
    ...
    extends AbstractCriterionConditions {
        ...
        public static Conditions items(ItemPredicate ... items) {
            return new Conditions(LootContextPredicate.EMPTY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, items);
        }
