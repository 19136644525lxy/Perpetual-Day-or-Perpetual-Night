...
extends AbstractCriterion<Conditions> {
    ...
    public Conditions conditionsFromJson(JsonObject jsonObject, LootContextPredicate lootContextPredicate, AdvancementEntityPredicateDeserializer advancementEntityPredicateDeserializer) {
        ...
        return new Conditions(lootContextPredicate, itemPredicate, lootContextPredicate2, itemPredicate2);
    }
    ...
    extends AbstractCriterionConditions {
        ...
        public static Conditions create(ItemPredicate rod, EntityPredicate bobber, ItemPredicate item) {
            return new Conditions(LootContextPredicate.EMPTY, rod, EntityPredicate.asLootContextPredicate(bobber), item);
        }
