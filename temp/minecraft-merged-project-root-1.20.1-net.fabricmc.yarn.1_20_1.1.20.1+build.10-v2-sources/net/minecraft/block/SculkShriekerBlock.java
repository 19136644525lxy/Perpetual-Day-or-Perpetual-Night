...
implements Waterloggable {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world2, BlockState state, BlockEntityType<T> type) {
        if (!world2.isClient) {
            return BlockWithEntity.checkType(type, BlockEntityType.SCULK_SHRIEKER, (world, pos, statex, sculkShriekerBlockEntity) -> Vibrations.Ticker.tick(world, sculkShriekerBlockEntity.getVibrationListenerData(), sculkShriekerBlockEntity.getVibrationCallback()));
        }
        return null;
    }
}
