...
public class LootTableReporter {
    ...
    public LootTableReporter makeChild(String name, LootDataKey<?> currentKey) {
        ImmutableCollection immutableSet = ((ImmutableSet.Builder)((ImmutableSet.Builder)ImmutableSet.builder().addAll(this.referenceStack)).add(currentKey)).build();
        return new LootTableReporter(this.messages, () -> this.getName() + name, this.contextType, this.dataLookup, (Set<LootDataKey<?>>)((Object)immutableSet));
    }
