...
extends ChoiceFix {
    ...
    private static Dynamic<?> updateSignTextFormat(Dynamic<?> dynamic) {
        ...
        Optional<Dynamic<?>> optional = dynamic.get("Color").result();
        dynamic2 = dynamic2.set("color", optional.isPresent() ? optional.get() : dynamic2.createString("black"));
        Optional<Dynamic<?>> optional2 = dynamic.get("GlowingText").result();
        dynamic2 = dynamic2.set("has_glowing_text", optional2.isPresent() ? optional2.get() : dynamic2.createBoolean(false));
